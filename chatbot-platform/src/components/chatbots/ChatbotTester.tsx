...
interface Message {
    ...
    isAI?: boolean;
    isGeneralAI?: boolean;
    isTyping?: boolean; // New property to track typing state
}
                ...
                <CardContent>
                    <div className="h-[400px] overflow-y-auto mb-4 p-4 border rounded-md">
                      ...
                      <span className="dot"></span>
                                ...
                                {!message.isUser && message.isAI && !message.isTyping && (
                                    <div className="mt-1">
                    <span className={`text-xs ${message.isGeneralAI ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800'} px-2 py-0.5 rounded-full`}>
