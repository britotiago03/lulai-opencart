...
-- Set search paths for each portion of the script
SET search_path TO chatbot_schema;

-- CHATBOT PLATFORM TABLES
...
-- Switch to ecommerce schema for ecommerce tables
...
-- Set search path back to default
